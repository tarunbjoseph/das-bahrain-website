        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="relative rounded-3xl p-6 glass-panel border border-white/15 overflow-hidden shadow-2xl">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[11px] bg-white/10 text-white font-medium px-2.5 py-0.5 rounded-full">
                    Bahrain 2026
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-das-900/90 border border-white/10 mb-3">
                  ...
                  <span className="text-xs font-mono font-bold text-emerald-400 bg-emerald-950/60 border border-emerald-500/30 px-2 py-1 rounded-lg">
                    Daily
                  </span>
                </div>

                {/* Floating Micro Feature 2: High Velocity Energy Drinks */}
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-das-900/90 border border-white/10">
                  <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-mono font-bold text-amber-400 bg-amber-950/60 border border-amber-500/30 px-2 py-1 rounded-lg">
                    Hot Pick
                  </span>
                </div>
